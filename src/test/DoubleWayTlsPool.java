...
public class DoubleWayTlsPool {
	...
	public static final String KEY_STORE_TRUST_PATH = "/home/tony/svr/svrdata/nginx/www/conf/certs/server.jks"; // truststore的路径
	public static final String KEY_STORE_TYPE_JKS = "jks"; // truststore的类型
	private static final String KEY_STORE_TRUST_PASSWORD = "server"; // truststore的密码
	public static final String KEY_STORE_CLIENT_PATH = "/home/tony/svr/svrdata/nginx/www/conf/certs/client-java.p12";
	...
	static {
		...
		try {
			...
			/*
			 * X509TrustManager xtm = new X509TrustManager(){ //创建TrustManager public void
			 ...
			 * X509Certificate[] getAcceptedIssuers() { return null; //return new
			 * java.security.cert.X509Certificate[0]; } }; sslcontext.init(null, new
			 * TrustManager[]{xtm}, null);
			 */
			// 解决bug结束
		} catch (Exception e) {
			e.printStackTrace();
		...
		// 个性化设置某个url的连接
		connManager.setMaxPerRoute(new HttpRoute(new HttpHost("api.cmhit.com", 8080)), 20);
	...
	public static void doubleWayAuthorizationAccepted() throws ClientProtocolException, IOException {
		...
		HttpGet httpget = new HttpGet("https://api.cmhit.com:8080/api/getToken?client_secret=P%40ssword_1&client_id=ankur.tandon.ap%40xxx.com");
		// 设置请求的配置
